...
[chain_all,~,len] = chain_summary(all_input,all_output,numData,input.output_path);
...
if ~isempty(len)
    ...
    [L2_value,fr_all,fr_change,x_loc_all,z_loc_all] = chain_stats(all_input,all_output,input.metrics_name,full_chain,numData,input.output_path);
